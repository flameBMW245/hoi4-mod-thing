...
static const float GB_STRENGTH_CH1 = 0.8; // Opacity of bottom layer, im confused lmao 1.0
static const float GB_STRENGTH_CH2 = 0.6; // Opacity of top layer, im crying i dont know what these mean 0.6
