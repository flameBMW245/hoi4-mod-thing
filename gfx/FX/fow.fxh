PixelShader = 
{
	...
	static const float HEIGHT_FOG_END = 20.0;
	static const float HEIGHT_FOG_START = 12.0;
	static const float HEIGHT_FOG_POW = 3.5;
	static const float HEIGHT_FOG_MAX = 1.0;
	
	static const float FOW_TRANSPARENCY_MIN = 0.2;
	static const float FOW_TRANSPARENCY_MAX = 0.9;
	
	static const float FOW_COLOR_MIN = 0.0;
	static const float FOW_COLOR_MAX = 1.0;
	
	static const float FOW_NOISE_TILING = 0.02;
	static const float FOW_NOISE_SPEED = 0.025;
	
	static const float3 BRIGHT_FOW_COLOR = float3(0.96, 0.75, 0.63);
	static const float3 DARK_FOW_COLOR = float3(0.05, 0.04, 0.04);
